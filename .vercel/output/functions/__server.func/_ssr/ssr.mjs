...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-1VFpTt27.mjs");
...
var manifest = { "be0d273ea49712ffe9d5a7db59c031ad95c8da4ba3acd7a4a805ae7b56a09236": {
	functionName: "pullRatesViaServer_createServerFn_handler",
	importer: () => import("./rates-DedIJeLm.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BavuBMf1.mjs").then((n) => n.t),
